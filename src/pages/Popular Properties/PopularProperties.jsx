...
const PopularProperties = () => {
  return (
    <div className="max-w-screen-xl mx-auto">
      <h1 className="text-[#111827] font-semibold text-3xl mt-5">
        Popular Properties
      ...
      <div className="grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-10 gap-5">
        {/* card */}
        <div className=" w-96  bg-base-100 shadow-xl relative">
          <figure>
          ...
          <div className="card-body">
            ...
            <div className="flex gap-28 ">
              <p className="text-sm font-normal text-[#111827]">Apartment</p>
        ...
        <div className=" w-96  bg-base-100 shadow-xl relative">
          ...
          <div className="card-body">
            <div className="absolute -mt-36 ml-[335px]">
